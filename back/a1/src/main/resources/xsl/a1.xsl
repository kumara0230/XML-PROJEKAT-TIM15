...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                xsi:schemaLocation="http://ftn.uns.ac.rs/a1 file:/home/drgcvc/Documents/xml/XML-PROJEKAT-TIM15/back/a1/src/main/resources/xsd/a1schema.xsd">
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <div class="section1">
                    <div class="item">
                        1) Podnosilac - ime, prezime, adresa i drzavljanstvo autora ili drugog nosioca autorskog prava ako je podnosilac fizičko lice, odnosno poslovno ime i sedište nosioca autorskog prava ako je podnosilac pravno lice*:
                        <table>
                            <tbody>
                                <tr><td class="answer"><xsl:value-of select="//a1:Podnosilac/a1:Ime"/></td>
                                    <xsl:choose>
                                        <xsl:when test="//a1:Podnosilac/a1:sediste">
                                            <td class="answer"><xsl:value-of select="//a1:Podnosilac/a1:sediste" /></td>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <td class="answer"><xsl:value-of select="//a1:Podnosilac/a1:prezime" /></td>
                                            <td class="answer"><xsl:value-of select="//a1:Podnosilac/a1:drzavljanstvo" /></td>
                                        </xsl:otherwise>
                                    </xsl:choose>
                                    <td class="answer"><xsl:value-of select="//a1:Podnosilac/a1:telefon" /></td>
                                    <td class="answer"><xsl:value-of select="//a1:Podnosilac/a1:email" /></td></tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        ...
                        <p class="answer"><xsl:value-of select="//a1:Delo/a1:naslov" /></p>
                        <p class="answer"><xsl:value-of select="//a1:Delo/a1:alternativni_naslov" /></p>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        ...
                        <p class="answer"><xsl:value-of select="//a1:Delo/a1:vrsta_dela" /></p>
                    </div>
                    <div class="item">
                        7) Podaci o formi zapisa autorskog dela (štampani tekst, optički disk i slično) *:
                        <p class="answer"><xsl:value-of select="//a1:Delo/a1:forma_zapisa" /></p>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        ...
                        <p class="answer"><xsl:value-of select="//a1:Delo/a1:nacin_koriscenja" /></p>
                    </div>
                </div>
                <h2>
                    POPUNjAVA ZAVOD:
