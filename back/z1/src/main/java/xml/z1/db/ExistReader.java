...
public class ExistReader {
    ...
    public List<ZahtevZaPriznanjeZiga> getAllRequests() throws Exception {
        ...
        ZahtevZaPriznanjeZiga zahtev = null;
        ...
        try {
            ...
            while (i.hasMoreResources()) {
                ...
                zahtev = (ZahtevZaPriznanjeZiga) unmarshaller.unmarshal(res.getContentAsDOM());
                zahtevi.add(zahtev);
            }
        } finally {
    ...
    public Resenje getResenjeByBrojPrijave(String brojPrijave) throws Exception {
        ...
        // initialize collection and document identifiers
        String collectionId = null;
        collectionId = "/db/resenja-zigovi";
