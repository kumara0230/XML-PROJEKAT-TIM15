...
public class PodnosilacDTO {
    ...
    public PodnosilacDTO(ZahtevZaPriznanjeZiga zahtev) {
        TLice podnosilac = zahtev.getPodaciOPodnosiocuPrijave();
        ...
        this.email = zahtev.getPodaciOPodnosiocuPrijave().getKontakt().getEmail();
